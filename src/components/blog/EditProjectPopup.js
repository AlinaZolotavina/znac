...
function EditProjectPopup({
    ...
    function handleProjectTitleChange(e) {
        ...
        if (e.target.value.length === 0) {
            ...
            setProjectTitleError('Only letters, numbers, quotes and underscores are allowed')
        } else {
    ...
    function handleProjectHashtagsChange(e) {
        ...
        if(e.target.value.length === 0) {
            ...
            setProjectHashtagsError('Only letters, numbers, underscores and dots are allowed')
        } else {
    ...
    }, [projectTitle, projectHashtags, textarea, projectLink, projectTitleError, projectHashtagsError,textareaError, projectLinkError]);
    ...
    return (
        <div className={`popup popup_type_get-in-touch ${isOpen && 'popup_is-opened'}`}>
