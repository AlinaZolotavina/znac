...
export const ADD_PHOTO_ERROR_MSG =
  "Failed to add photo. There may be a connection problem or the server is unavailable. Please wait and try again.";
export const DELETE_PHOTO_ERROR_MSG =
  "Failed to delete photo. There may be a connection problem or the server is unavailable. Please wait and try again.";
